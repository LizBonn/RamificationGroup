...
and María Inés de Frutos-Fernández's relevant developments in [local class field theory](https://github.com/mariainesdff/LocalClassFieldTheory). Our formalization primarily follows Serre's treatise [Local Fields](doc/Local Fields (Jean-Pierre Serre) (Z-Library).pdf) as the foundational
