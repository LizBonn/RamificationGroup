...
instance ValAlgHom.algHom : Coe (ValAlgHom R A B) (AlgHom R A B) := ⟨ValAlgHom.toAlgHom⟩

instance ValAlgEquiv.algEquiv: Coe (ValAlgEquiv R A B) (AlgEquiv R A B) := ⟨ValAlgEquiv.toAlgEquiv⟩
