...
\begin{theorem}\label{lowerIndex_eq_top_iff_eq_refl}
        ...
        \uses{Valued.decompositionGroup,lowerIndex_ne_one,eq_top,lowerIndex,ValRingHom.comp,ValAlgEquiv.refl,ValAlgEquiv.one_apply}
                No documentation.
    \end{theorem}
...
\begin{theorem}\label{lowerIndex_ne_refl}
        ...
        \uses{Valued.decompositionGroup,Valued.decompositionGroup_one,Valued.decompositionGroup_eq_top,lowerIndex_ne_one,eq_top,lowerIndex,ext,ValRingHom.comp,ValAlgEquiv.refl}
                No documentation.
    \end{theorem}
...
\begin{theorem}\label{aux1}
        \lean{aux1}
        \uses{lowerRamificationGroup,le_truncatedLowerIndex_sub_one_iff_mem_lowerRamificationGroup,lowerIndex_ne_refl,lowerIndex,RamificationGroup,ValAlgEquiv.refl,Valuation.Nontrivial}
                No documentation.
    \end{theorem}
